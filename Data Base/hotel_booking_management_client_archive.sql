...
--
-- Dumping data for table `client_archive`
--

LOCK TABLES `client_archive` WRITE;
/*!40000 ALTER TABLE `client_archive` DISABLE KEYS */;
/*!40000 ALTER TABLE `client_archive` ENABLE KEYS */;
UNLOCK TABLES;
